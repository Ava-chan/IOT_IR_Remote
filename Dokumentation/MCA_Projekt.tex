...
\subsubsection{Loop}
%TODO ahhh grübel, wegen guter und sinnvoller darstellung....
\begin{figure}[!ht]
\centering 
\begin{tikzpicture}[node distance = 2cm, auto, scale=0.8, every node/.style={scale=0.8}]
    % Place nodes
...
\section{Verwendung}
%TODO
%Wie wird das Gerät verwendet nochmal erklären und mit Screenshots unterlegen
